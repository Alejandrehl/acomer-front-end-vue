<template>
  <Modal class="acomer_modal pedido_dentro_local_modal" 
  :show="showModal" 
  @close-modal="toggle_modal_state({name:'loading_transaction',value:false})">
    <img src="~/assets/img/logo.png" alt="" class="logo">
    <h2>Transacción esta en proceso</h2>
